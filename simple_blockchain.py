...
class Blockchain:
    ...
    def new_block(self, proof, previous_hash=None, message=None):
        ...
        :param message: (Optional) <str> A special message to be included in the block
...
def mine():
    ...
    response = {
        'message': "New PetrovicCoin Block Forged",
        'index': block['index'],
...
def index():
    response = {
        'message': "Welcome to PetrovicCoin Blockchain. Available endpoints:",
        'endpoints': {
